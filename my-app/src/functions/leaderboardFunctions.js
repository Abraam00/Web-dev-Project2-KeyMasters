...
export async function validateQR(url) {
  ...
  return axios
    .post(
      `${config.API.BASE_URL}/leaderboard/qr`,
      { url: url },
      {
        headers: {
...
export async function createTeam(team, url) {
  ...
  return axios
    .post(
      `${config.API.BASE_URL}/leaderboard/create`,
      {
        teamname: team,
...
export async function updateTeam(team, url) {
  ...
  return await axios
    .put(
      `${config.API.BASE_URL}/leaderboard/update`,
      {
        teamname: team,
        _found: url,
      },
...
export async function getHint(url) {
  return await axios.get(`${config.API.BASE_URL}/qr/hint`);
}
